...
import type { PoseLandmarks } from '../types/mediapipe';

type CameraErrorType = 'PERMISSION_DENIED' | 'NOT_FOUND' | 'GENERAL';

const CameraErrorType = {
  DENIED: 'PERMISSION_DENIED' as CameraErrorType,
  NOT_FOUND: 'NOT_FOUND' as CameraErrorType,
  GENERAL: 'GENERAL' as CameraErrorType,
} as const;
...
export { CameraErrorType, CameraError };